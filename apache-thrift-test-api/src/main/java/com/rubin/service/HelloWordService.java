...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2016-06-19")
public class HelloWordService {

  public interface Iface {

    public String doAction(com.rubin.domain.Request request) throws com.rubin.exception.RequestException, org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void doAction(com.rubin.domain.Request request, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_doAction(com.rubin.domain.Request request) throws org.apache.thrift.TException
    {
    ...
    public String recv_doAction() throws com.rubin.exception.RequestException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class doAction_call extends org.apache.thrift.async.TAsyncMethodCall {
      private com.rubin.domain.Request request;
      public doAction_call(com.rubin.domain.Request request, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public String getResult() throws com.rubin.exception.RequestException, org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class doAction<I extends Iface> extends org.apache.thrift.ProcessFunction<I, doAction_args> {
      ...
      public doAction_result getResult(I iface, doAction_args args) throws org.apache.thrift.TException {
        ...
        } catch (com.rubin.exception.RequestException qe) {
          result.qe = qe;
        }
        return result;
      }
      ...
      public AsyncMethodCallback<String> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        ...
        return new AsyncMethodCallback<String>() { 
          ...
          public void onError(Exception e) {
            ...
            doAction_result result = new doAction_result();
            if (e instanceof com.rubin.exception.RequestException) {
                        result.qe = (com.rubin.exception.RequestException) e;
  ...
  public static class doAction_args implements org.apache.thrift.TBase<doAction_args, doAction_args._Fields>, java.io.Serializable, Cloneable, Comparable<doAction_args>   {
    ...
    public com.rubin.domain.Request request; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.REQUEST, new org.apache.thrift.meta_data.FieldMetaData("request", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.rubin.domain.Request.class)));
    ...
    public doAction_args(
      com.rubin.domain.Request request)
    {
      this();
      this.request = request;
    }
    ...
    public doAction_args(doAction_args other) {
      if (other.isSetRequest()) {
        this.request = new com.rubin.domain.Request(other.request);
      }
    }
    ...
    public com.rubin.domain.Request getRequest() {
      return this.request;
    }

    public doAction_args setRequest(com.rubin.domain.Request request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((com.rubin.domain.Request)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.request = new com.rubin.domain.Request();
  ...
  public static class doAction_result implements org.apache.thrift.TBase<doAction_result, doAction_result._Fields>, java.io.Serializable, Cloneable, Comparable<doAction_result>   {
    ...
    public com.rubin.exception.RequestException qe; // required
    ...
    public doAction_result(
      String success,
      com.rubin.exception.RequestException qe)
    {
      this();
    ...
    public doAction_result(doAction_result other) {
      ...
      if (other.isSetQe()) {
        this.qe = new com.rubin.exception.RequestException(other.qe);
      }
    }
    ...
    public com.rubin.exception.RequestException getQe() {
      return this.qe;
    }

    public doAction_result setQe(com.rubin.exception.RequestException qe) {
      this.qe = qe;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case QE:
        if (value == null) {
          ...
          setQe((com.rubin.exception.RequestException)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, doAction_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 1: // QE
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.qe = new com.rubin.exception.RequestException();
